...
//UTILS
import { MONTH_LIST, NUM_DAY_IN_MONTH, GENDER_OPTIONS , ACTIVATION_ROUTE, USER_EXISTS_ERR_CODE,  emailValidator, ALL_FIELDS_FILLED, ALL_FIELDS_REQUIRED_ERR, USER_EXISTS_ERR } from '../constants';
...
const Signup = () => {
    ...
    useEffect(()=>{setMsg({...msg, show:false})},[form])
    const [msg, setMsg] = useState({text:'test',show:true, type:'err'})
    ...
    const handleSubmit =async () => {
        ...
        if(ALL_FIELDS_FILLED(form) && emailValidator(form.email)){
        ...
        else setMsg({text:ALL_FIELDS_REQUIRED_ERR, show:true})
    }
        ...
        <div className="signup">
            <ModalOuterContainer  color="#d9d9d9">
                    ...
                    <div style={{margin:'10px'}}>
                        ...
                        <ModalInput onChange={onChange} id="surname" type="text" placeholder="Surname"/>
                        <ModalInput isValid={emailValidator(form.email)} value={form.email} onChange={onChange} id="email" type="text" placeholder="Email Address"/>
                    ...
                    <ModalButtonContainer justify="space-between">
                        <ModalButton size="small" onClick={loginRedirect} text="Log in"/>
